      ...
      var n = {},
        ...
        l = function () {
          (n.settings = t.extend({}, e, o)),
            ...
            n.children.length < n.settings.minSlides &&
              (n.settings.minSlides = n.children.length),
            n.children.length < n.settings.maxSlides &&
              (n.settings.maxSlides = n.children.length),
            n.settings.randomStart &&
              (n.settings.startSlide = Math.floor(
                Math.random() * n.children.length
              )),
            (n.active = { index: n.settings.startSlide }),
            (n.carousel =
              n.settings.minSlides > 1 || n.settings.maxSlides > 1 ? !0 : !1),
            n.carousel && (n.settings.preloadImages = "all"),
            (n.minThreshold =
              n.settings.minSlides * n.settings.slideWidth +
              (n.settings.minSlides - 1) * n.settings.slideMargin),
            (n.maxThreshold =
              n.settings.maxSlides * n.settings.slideWidth +
              (n.settings.maxSlides - 1) * n.settings.slideMargin),
            (n.working = !1),
            (n.controls = {}),
            (n.interval = null),
            ...
            "vertical" === n.settings.mode &&
              (n.settings.maxSlides = n.settings.minSlides),
        ...
        c = function () {
          s.wrap(
            ...
            s.css({
              width:
                "horizontal" === n.settings.mode
                  ? 1e3 * n.children.length + 215 + "%"
                  : "auto",
              position: "absolute",
            }),
            n.usingCSS && n.settings.easing
              ? s.css(
                  "-" + n.cssPrefix + "-transition-timing-function",
                  n.settings.easing
                )
            ...
            n.settings.pager ||
              n.settings.controls ||
              n.viewport.parent().css({ margin: "0 auto 0px" }),
            n.children.css({
            ...
            "fade" === n.settings.mode &&
              ...
              n.children
                .eq(n.settings.startSlide)
                .css({ zIndex: n.settings.slideZIndex, display: "block" })),
          ...
          ("all" === n.settings.preloadImages || n.settings.ticker) &&
            (e = n.children),
            n.settings.ticker
              ? (n.settings.pager = !1)
        ...
        h = function () {
          if (
            ...
            var e =
                "vertical" === n.settings.mode
                  ? n.settings.minSlides
                  : n.settings.maxSlides,
            ...
            if (n.carousel) {
              var s =
                1 === n.settings.moveSlides
                  ...
                  : n.active.index * v();
              for (
                o = n.children.eq(s), i = 1;
                i <= n.settings.maxSlides - 1;
                i++
              )
                o = o.add(
                  n.children.eq(s + i >= n.children.length ? i - 1 : s + i)
                );
          ...
          return (
            "vertical" === n.settings.mode
              ? (o.each(function () {
                ...
                n.settings.slideMargin > 0 &&
                  (e += n.settings.slideMargin * (n.settings.minSlides - 1)))
              : (e = Math.max.apply(
                  Math,
                  o
                    .map(function () {
        ...
        f = function () {
          var t = n.settings.slideWidth,
            e = n.viewport.width();
          return (
            0 === n.settings.slideWidth ||
            (n.settings.slideWidth > e && !n.carousel) ||
            "vertical" === n.settings.mode
              ? (t = e)
              : n.settings.maxSlides > 1 &&
                ...
                (e > n.maxThreshold ||
                  (e < n.minThreshold &&
                    (t =
                      (e -
                        n.settings.slideMargin * (n.settings.minSlides - 1)) /
                      n.settings.minSlides))),
            t
          );
        },
            ...
            if (n.settings.infiniteLoop) t = Math.ceil(n.children.length / v());
              ...
              for (var e = 0, i = 0; e < n.children.length; )
                ++t,
                  (e = i + m()),
                  (i +=
                    n.settings.moveSlides <= m() ? n.settings.moveSlides : m());
          else t = Math.ceil(n.children.length / m());
          return t;
        },
        v = function () {
          return n.settings.moveSlides > 0 && n.settings.moveSlides <= m()
            ? n.settings.moveSlides
            : m();
        },
        w = function () {
          var t;
          if (
            ...
            if ("horizontal" === n.settings.mode) {
              ...
              (t = e.position()),
                y(
                  -(t.left - (n.viewport.width() - e.outerWidth())),
                  "reset",
                  0
                );
        ...
        b = function () {
          for (var e = "", i = g(), o = 0; i > o; o++) {
            var s = "";
            (n.settings.buildPager && t.isFunction(n.settings.buildPager)) ||
            n.settings.pagerCustom
              ? ((s = n.settings.buildPager(o)),
                n.pagerEl.addClass("bx-custom-pager"))
        ...
        S = function () {
          (n.controls.next = t(
            '<a class="bx-next" href="">' + n.settings.nextText + "</a>"
          )),
            (n.controls.prev = t(
              '<a class="bx-prev" href="">' + n.settings.prevText + "</a>"
            )),
            n.controls.next.bind("click touchend", k),
            n.controls.prev.bind("click touchend", E),
            n.settings.nextSelector &&
              t(n.settings.nextSelector).append(n.controls.next),
            n.settings.prevSelector &&
              t(n.settings.prevSelector).append(n.controls.prev),
            n.settings.nextSelector ||
              n.settings.prevSelector ||
              ((n.controls.directionEl = t(
                '<div class="bx-controls-direction" />'
              )),
              n.controls.directionEl
                .append(n.controls.prev)
                .append(n.controls.next),
              n.controls.el
                .addClass("bx-has-controls-direction")
                .append(n.controls.directionEl));
        },
        T = function () {
          (n.controls.start = t(
            '<div class="bx-controls-auto-item"><a class="bx-start" href="">' +
              n.settings.startText +
              "</a></div>"
          )),
            (n.controls.stop = t(
        ...
        k = function (t) {
          t.preventDefault(),
            n.controls.el.hasClass("disabled") ||
              (n.settings.auto && s.stopAuto(), s.goToNextSlide());
        },
        E = function (t) {
          t.preventDefault(),
            n.controls.el.hasClass("disabled") ||
              (n.settings.auto && s.stopAuto(), s.goToPrevSlide());
        },
        z = function (t) {
        ...
        M = function (e) {
          ...
          return "short" === n.settings.pagerType
            ? (n.settings.maxSlides > 1 &&
                (i = Math.ceil(n.children.length / n.settings.maxSlides)),
        ...
        $ = function () {
          if (n.settings.infiniteLoop) {
            ...
            0 === n.active.index
              ...
              : n.active.index === n.children.length - 1 &&
                (t = n.children.eq(n.children.length - 1).position()),
              t &&
                ("horizontal" === n.settings.mode
                  ? y(-t.left, "reset", 0)
                  : "vertical" === n.settings.mode && y(-t.top, "reset", 0));
          ...
          (n.working = !1),
            n.settings.onSlideAfter(
              n.children.eq(n.active.index),
              n.oldIndex,
              n.active.index
            );
        },
        ...
        A = function () {
          1 === g()
            ? (n.controls.prev.addClass("disabled"),
              n.controls.next.addClass("disabled"))
            : !n.settings.infiniteLoop &&
              n.settings.hideControlOnEnd &&
              (0 === n.active.index
                ? (n.controls.prev.addClass("disabled"),
                  n.controls.next.removeClass("disabled"))
                : n.active.index === g() - 1
                ? (n.controls.next.addClass("disabled"),
                  n.controls.prev.removeClass("disabled"))
                : (n.controls.prev.removeClass("disabled"),
                  n.controls.next.removeClass("disabled")));
        },
        O = function () {
              ...
              n.viewport.hover(
                ...
                function () {
                  ...
                  var i = n.settings.speed / e,
                    s =
                      ("horizontal" == n.settings.mode ? "left" : "top",
                      i * (e - Math.abs(parseInt(o))));
                  N(s);
                }
              );
            } else
        ...
        H = function () {
          (n.touch = { start: { x: 0, y: 0 }, end: { x: 0, y: 0 } }),
            ...
            n.viewport.on("click", ".bxslider a", function (t) {
              n.viewport.hasClass("click-disabled") &&
                (t.preventDefault(), n.viewport.removeClass("click-disabled"));
            });
        },
        B = function (t) {
          if ((n.controls.el.addClass("disabled"), n.working))
            ...
            (n.touch.start.x = i[0].pageX),
              ...
              n.viewport.get(0).setPointerCapture &&
                ...
                n.viewport.get(0).setPointerCapture(n.pointerId)),
        ...
        j = function () {
          y(n.touch.originalPos.left, "reset", 0),
            ...
            n.viewport.get(0).releasePointerCapture &&
              n.viewport.get(0).releasePointerCapture(n.pointerId);
        },
        W = function (t) {
          var e = t.originalEvent,
          ...
          if (
            (3 * o > s && n.settings.preventDefaultSwipeX
              ? t.preventDefault()
              : 3 * s > o &&
                n.settings.preventDefaultSwipeY &&
                t.preventDefault(),
            ...
            var r = 0,
              a = 0;
            "horizontal" === n.settings.mode
              ? ((a = i[0].pageX - n.touch.start.x),
                (r = n.touch.originalPos.left + a))
              : ((a = i[0].pageY - n.touch.start.y),
                (r = n.touch.originalPos.top + a)),
              y(r, "reset", 0);
          }
        },
        F = function (t) {
            ...
            "fade" === n.settings.mode
              ? ((r = Math.abs(n.touch.start.x - n.touch.end.x)),
                r >= n.settings.swipeThreshold &&
                  (n.touch.start.x > n.touch.end.x
                    ? s.goToNextSlide()
                    : s.goToPrevSlide(),
                  s.stopAuto()))
              : ("horizontal" === n.settings.mode
                  ? ((r = n.touch.end.x - n.touch.start.x),
                    (o = n.touch.originalPos.left))
                  : ((r = n.touch.end.y - n.touch.start.y),
                    (o = n.touch.originalPos.top)),
                !n.settings.infiniteLoop &&
                ((0 === n.active.index && r > 0) || (n.active.last && 0 > r))
                  ? y(o, "reset", 200)
                  : Math.abs(r) >= n.settings.swipeThreshold
                  ? (0 > r ? s.goToNextSlide() : s.goToPrevSlide(),
                    s.stopAuto())
                  : y(o, "reset", 200)),
            n.viewport.unbind("touchend MSPointerUp pointerup", F),
            n.viewport.get(0).releasePointerCapture &&
          ...
          if (n.initialized)
            if (n.working) window.setTimeout(q, 10);
              ...
              (r !== e || a !== i) &&
                ...
                (a = i),
                s.redrawSlider(),
                n.settings.onSliderResize.call(s, n.active.index));
            }
        };
      return (
        (s.goToSlide = function (e, i) {
          if (!n.working && n.active.index !== e) {
            (n.working = !0),
              ...
              (n.active.index = 0 > e ? g() - 1 : e >= g() ? 0 : e);
            var o = !0;
            if (
              ((o = n.settings.onSlideBefore(
                n.children.eq(n.active.index),
                n.oldIndex,
                n.active.index
              )),
            ...
            if (
              ("next" === i
                ? n.settings.onSlideNext(
                    n.children.eq(n.active.index),
                    n.oldIndex,
                    n.active.index
                  ) || (o = !1)
                : "prev" === i &&
                  (n.settings.onSlidePrev(
                    n.children.eq(n.active.index),
                    n.oldIndex,
                    n.active.index
                  ) ||
            ...
            if (
              ...
              if (!n.settings.infiniteLoop && n.carousel && n.active.last)
                ...
                (a = s.find("> .bx-clone").eq(n.settings.maxSlides).position()),
                  (n.active.last = !1);
              else if (e >= 0) {
                var h = e * v();
              ...
              if ("undefined" != typeof a) {
                var p =
                  "horizontal" === n.settings.mode ? -(a.left - r) : -a.top;
        ...
        (s.stopAuto = function (t) {
          n.interval &&
            ...
            (n.interval = null),
            n.settings.autoControls && t !== !0 && P("start"));
        }),
    ...
    var s = "stellar",
      ...
      c = (function () {
        ...
        return (
          ...
          function (t) {
            return (
              n + (n.length > 0 ? t.charAt(0).toUpperCase() + t.slice(1) : t)
            );
          }
        );
      })(),
      ...
      _defineSetters: function () {
        ...
        (this._setScrollLeft =
          ...
          (this._setPosition =
            o.setPosition ||
            function (t, i, n, s, r) {
              e.options.horizontalScrolling && o.setLeft(t, i, n),
                e.options.verticalScrolling && o.setTop(t, s, r);
            });
      },
            ...
            this.$element.find("[data-stellar-ratio]").each(function () {
              ...
              e.options.showElement(u),
                ...
                e.particles.push({
                  ...
                  parentOffsetTop: f,
                  stellarRatio:
                    u.data("stellar-ratio") !== o ? u.data("stellar-ratio") : 1,
            ...
            e.each(function () {
              ...
              f.data("stellar-backgroundStartingLeft")
                ...
                i.backgrounds.push({
                  ...
                  parentOffsetTop: v,
                  stellarRatio:
                    f.data("stellar-background-ratio") === o
                      ? 1
        ...
        return e === o || "object" == typeof e
          ? this.each(function () {
              t.data(this, "plugin_" + s) ||
                t.data(this, "plugin_" + s, new n(this, e));
            })
...
if (
    ...
    (i.VERSION = "3.3.4"),
      ...
      (i.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
        ...
        if (/right|left/.test(t)) {
          ...
          c < r.left
            ? (n.left = r.left - c)
            : d > r.width && (n.left = r.left + r.width - d);
        }
        return n;
      }),
  ...
  (function () {
    $(".footer-bottom").parent().is(".copy-right.pull-right")
      ...
      : $(".copy-right").append(
          '<a href="http://demos.jeweltheme.com/polmo" target="_blank">Copyrights © 2023</a> - Todos os Direitos Reservados. Desenvolvido por <a href="http://jeweltheme.com/" target="_blank">Jocimar Galante</a>.'
        );
  })(jQuery),
  (function (t) {
          ...
          function e(e) {
            if ((i.preventDefaultEvents && e.preventDefault(), r)) {
              ...
              Math.abs(l) >= i.min_move_x
                ...
                : Math.abs(c) >= i.min_move_y &&
                  (t(), c > 0 ? i.wipeDown() : i.wipeUp());
            }
          }
          function o(t) {
            1 == t.touches.length &&
  ...
  !(function (t) {
    ...
    (y.prototype = {
      ...
      updateItemHTML: function () {
        ...
        var o = i.type;
        if (
          (C("BeforeChange", [e.currItem ? e.currItem.type : "", o]),
          (e.currItem = i),
          !e.currTemplate[o])
        ) {
        ...
        getInline: function (i, o) {
          if ((P(), i.src)) {
            ...
            if (s.length) {
              ...
              r &&
                r.tagName &&
                (_ || ((I = n.hiddenClass), (_ = T(I)), (I = "mfp-" + I)),
                (M = s.after(_).detach().removeClass(I))),
        ...
        (t.fn.mfpFastClick = function (n) {
                  ...
                  x
                    .on("touchmove" + s, function (t) {
                      (u = t.originalEvent
                        ...
                        (p = u.length),
                        (u = u[0]),
                        (Math.abs(u.clientX - c) > 10 ||
                          Math.abs(u.clientY - d) > 10) &&
                          ((h = !0), o());
                    })
          ...
          (t.fn.destroyMfpFastClick = function () {
            t(this).off("touchstart" + s + " click" + s),
              i && x.off("touchmove" + s + " touchend" + s);
          });
      })(),
      E();
  }),
    ...
    function i(t, i) {
      if (((this.path = t || ""), "undefined" != typeof i && null !== i))
        ...
        if (void 0 !== document.createElement) {
          ...
          (o.href = this.path),
            (o.pathname = o.pathname.replace(r, e)),
            (this.at_2x_path = o.href);
        } else {
      ...
      (t.init = function (t) {
        ...
        t.onload = function () {
          ...
          for (t = 0; t < n.length; t += 1)
            (i = n[t]),
              i.getAttributeNode("data-no-retina") || s.push(new o(i));
          e();
        };
      }),
      (t.isRetina = function () {
      ...
      (e.Isotope.prototype = {
        _create: function (t) {
          ...
          for (var s = 0, r = o.length; r > s; s++)
            (n = o[s]), (this.originalStyle[n] = i[n] || "");
          ...
          var t = this.options.sortBy,
            ...
            o = function (o, n) {
              ...
              return (
                s === r &&
                  "original-order" !== t &&
                  ((s = e(o, "original-order")), (r = e(n, "original-order"))),
                (s > r ? 1 : r > s ? -1 : 0) * i
              );
            };
        ...
        _pushPosition: function (t, e, i) {
          ...
          this.styleQueue.push({ $el: t, style: o }),
            this.options.itemPositionDataEnabled &&
              t.data("isotope-item-position", { x: e, y: i });
        },
        layout: function (t, e) {
        ...
        _processStyleQueue: function (t, i) {
          ...
          if (
            ...
            if (
              ...
              for (
                var f, v = 0, w = this.styleQueue[0], y = w && w.$el;
                !y || !y.length;
        ...
        _getSegments: function (t) {
          var e,
            ...
            l =
              ...
              this.$filteredAtoms["outer" + s(n)](!0) ||
              a;
          (e = Math.floor(a / l)),
            (e = Math.max(e, 1)),
            (this[i][r] = e),
          ...
          t.each(function () {
            ...
            if (((n = Math.min(n, o.cols)), 1 === n))
              ...
              var s,
                ...
                l = [];
              for (r = 0; a > r; r++)
                (s = o.colYs.slice(r, r + n)), (l[r] = Math.max.apply(Math, s));
        ...
        _masonryPlaceBrick: function (t, e) {
          for (
            var i = Math.min.apply(Math, e), o = 0, n = 0, s = e.length;
            s > n;
            n++
          )
            if (e[n] === i) {
          ...
          t.each(function () {
            ...
            if (((n = Math.min(n, o.rows)), 1 === n))
              ...
              var s,
                ...
                l = [];
              for (r = 0; a > r; r++)
                (s = o.rowXs.slice(r, r + n)), (l[r] = Math.max.apply(Math, s));
      ...
      (e.fn.imagesLoaded = function (t) {
        ...
        function o(t) {
          ...
          n.src !== a &&
            -1 === e.inArray(n, l) &&
            (l.push(n),
            --r <= 0 && (setTimeout(i), s.unbind(".imagesLoaded", o)));
        }
        var n = this,
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (t, e, i, o, n) {
      ...
      return (
        a * Math.pow(2, -10 * e) * Math.sin((2 * (e * n - s) * Math.PI) / r) +
        o +
        i
      );
    },
    ...
    easeInOutBounce: function (t, e, i, o, n) {
      return n / 2 > e
        ...
        : 0.5 * jQuery.easing.easeOutBounce(t, 2 * e - n, 0, o, n) +
            0.5 * o +
            i;
    },
  }),
  ...
  (function (t) {
    ...
    var h = window.MutationObserver || window.WebKitMutationObserver || !1,
      ...
      f = function () {
        ...
        e.ischrome26 && (e.prefixstyle = n[1]),
      ...
      m = function (r, c) {
        ...
        (this.iddoc =
          (this.doc = w.opt.doc) && this.doc[0] ? this.doc[0].id || "" : ""),
          (this.ispage = /^BODY|HTML/.test(
            w.opt.win ? w.opt.win[0].nodeName : this.doc[0].nodeName
          )),
        ...
        (this.ishwscroll =
          (this.canhwscroll = b.hastransform && w.opt.hwacceleration) &&
          w.haswrapper),
          ...
          b.cantouch &&
            ...
            !b.isios &&
            !b.isandroid &&
            ((this.istouchcapable = !0), (b.cantouch = !1)),
          b.cantouch &&
            b.ismozilla &&
            !b.isios &&
            !b.isandroid &&
            ((this.istouchcapable = !0), (b.cantouch = !1)),
          w.opt.enablemouselockapi ||
        ...
        (this.getOffset = function () {
          ...
          (this.updateScrollBar = function (t) {
            if (w.ishwscroll)
              w.rail.css({ height: w.win.innerHeight() }),
                w.railh && w.railh.css({ width: w.win.innerWidth() });
            else {
              var e = w.getOffset(),
                i = e.top,
                o = e.left,
              ...
              var o =
                  ...
                  (w.rail.align
                    ? w.win.outerWidth() -
                      p(w.win, "border-right-width") -
                      w.rail.width
                    : p(w.win, "border-left-width")),
                n = w.opt.railoffset;
              n &&
                (n.top && (i += n.top),
                w.rail.align && n.left && (o += n.left)),
                w.locked ||
                  w.rail.css({
                    top: i,
                    left: o,
            ...
            w.locked ||
              ...
              e
                ? ((e = i ? w.doScrollLeft : w.doScrollTop),
                  (o = i
                    ? (t.pageX - w.railh.offset().left - w.cursorwidth / 2) *
                      w.scrollratio.x
                    : (t.pageY - w.rail.offset().top - w.cursorheight / 2) *
                      w.scrollratio.y),
                  e(o))
                : ((e = i ? w.doScrollLeftBy : w.doScrollBy),
                  (o = i ? w.scroll.x : w.scroll.y),
                  (t = i
                    ? t.pageX - w.railh.offset().left
                    : t.pageY - w.rail.offset().top),
          ...
          (this.init = function () {
            ...
            if (
              (b.hasmstouch &&
                w.css(w.ispage ? t("html") : w.win, {
                  "-ms-touch-action": "none",
                }),
              (w.zindex = "auto"),
              (w.zindex =
                w.ispage || "auto" != w.opt.zindex
                  ? w.opt.zindex
                  : d() || "auto"),
              ...
              w.ispage && (n = w.haswrapper ? w.win : w.doc),
                ...
                w.ispage &&
                  ...
                  ("BODY" == w.doc[0].nodeName
                    ...
                    : "HTML" == w.doc[0].nodeName &&
                      w.css(t("body"), { "overflow-y": "hidden" })),
                b.isios &&
                  !w.ispage &&
                  !w.haswrapper &&
                  w.css(t("body"), { "-webkit-overflow-scrolling": "touch" });
              ...
              for (u in p)
                (c = p[u]),
                  (l = w.opt.railpadding[c])
                    ? a.css("padding-" + c, l + "px")
                    : (w.opt.railpadding[c] = 0);
              if (
                (a.append(r),
                (a.width =
                ...
                w.opt.boxzoom &&
                  ...
                  b.cantouch &&
                    ...
                    ((w.ongesturezoom = function (t) {
                      return (
                        1.5 < t.scale && w.doZoomIn(t),
                        0.8 > t.scale && w.doZoomOut(t),
                        w.cancelEvent(t)
                      );
                    }),
              ...
              if (
                (w.ispage
                  ? (a.css({ position: "fixed", top: "0px", height: "100%" }),
                    ...
                    w.railh &&
                      ...
                      w.body.append(f)))
                  : (w.ishwscroll
                      ? ("static" == w.win.css("position") &&
                          w.css(w.win, { position: "relative" }),
                    ...
                    b.isie &&
                      w.opt.disableoutline &&
                      w.win.attr("hideFocus", "true"),
                    b.iswebkit &&
                      w.opt.disableoutline &&
                      w.win.css({ outline: "none" })),
                !1 === w.opt.autohidemode
                  ...
                  ? ((w.autohidedom = t().add(w.rail)),
                    ...
                    w.railh &&
                      b.isie8 &&
                      (w.autohidedom = w.autohidedom.add(w.cursorh)))
                  : "scroll" == w.opt.autohidemode
                  ? ((w.autohidedom = t().add(w.rail)),
                    w.railh && (w.autohidedom = w.autohidedom.add(w.railh)))
                  : "cursor" == w.opt.autohidemode
                  ? ((w.autohidedom = t().add(w.cursor)),
                    w.railh && (w.autohidedom = w.autohidedom.add(w.cursorh)))
                  : "hidden" == w.opt.autohidemode &&
                    ((w.autohidedom = !1), w.hide(), (w.locked = !1)),
                b.isie9mobile)
              )
                (w.scrollmom = new g(w)),
                  (w.onmangotouch = function (t) {
                    ...
                    if (
                      t == w.scrollmom.lastscrolly &&
                      e == w.scrollmom.lastscrollx
                    )
                      return !0;
                      ...
                      w.mangotouch.lazy && clearTimeout(w.mangotouch.lazy),
                        ...
                        w.mangotouch.drx != s
                          ...
                          : (w.scrollmom.stop(),
                            ...
                            (w.mangotouch.tm = r),
                            (i = Math.max(
                              Math.abs(w.mangotouch.ly - t),
                              Math.abs(w.mangotouch.lx - e)
                            )),
                            (w.mangotouch.ly = t),
                            (w.mangotouch.lx = e),
                            i > 2 &&
                ...
                if (
                  ...
                  var m =
                    w.opt.touchbehavior && w.isiframe && !b.hasmousecapture;
                      ...
                      if (
                        (w.ishwscroll && w.opt.bouncescroll
                          ? 0 > l
                            ...
                            : l > w.page.maxh &&
                              (l =
                                w.page.maxh + Math.round((l - w.page.maxh) / 2))
                          : (0 > l && (s = l = 0),
                            l > w.page.maxh && ((l = w.page.maxh), (s = 0))),
                        ...
                        w.ishwscroll && w.opt.bouncescroll
                          ? 0 > c
                            ...
                            : c > w.page.maxw &&
                              (c =
                                w.page.maxw + Math.round((c - w.page.maxw) / 2))
                          : (0 > c && (r = c = 0),
                            c > w.page.maxw && ((c = w.page.maxw), (r = 0)));
                      }
                      if (((o = !1), w.rail.drag.dl))
                        (o = !0),
                          "v" == w.rail.drag.dl
                            ? (c = w.rail.drag.sl)
                            : "h" == w.rail.drag.dl && (l = w.rail.drag.st);
                      else {
                        var n = Math.abs(n),
                          a = Math.abs(a),
                      ...
                      if (
                        (w.synched("touchmove", function () {
                          w.rail.drag &&
                            ...
                            w.railh && w.railh.scrollable
                              ? (w.setScrollLeft(c), w.showCursor(l, c))
                              : w.showCursor(l),
                ...
                if (
                  ((w.onmousedown = function (t, e) {
                    if (!w.rail.drag || 1 == w.rail.drag.pt) {
                      ...
                      return (
                        ...
                        w.isiframe &&
                          !b.hasmousecapture &&
                          ((w.saved.csspointerevents =
                            w.doc.css("pointer-events")),
                  ...
                  (w.onmouseup = function (t) {
                    return w.rail.drag &&
                      ...
                      w.isiframe &&
                        !b.hasmousecapture &&
                        w.doc.css("pointer-events", w.saved.csspointerevents),
                      1 == w.rail.drag.pt)
                      ? ((w.rail.drag = !1),
                  ...
                  (w.onmousemove = function (t) {
                    if (w.rail.drag && 1 == w.rail.drag.pt) {
                      ...
                      if (
                        ...
                        (w.scroll.x =
                          w.rail.drag.sx + (t.clientX - w.rail.drag.x)),
                          0 > w.scroll.x && (w.scroll.x = 0);
                        var e = w.scrollvaluemaxw;
                        w.scroll.x > e && (w.scroll.x = e);
                      } else
                        (w.scroll.y =
                          w.rail.drag.sy + (t.clientY - w.rail.drag.y)),
                      ...
                      return (
                        w.synched("mousemove", function () {
                          w.rail.drag &&
                            ...
                            w.rail.drag.hr
                              ? w.doScrollLeft(
                                  Math.round(w.scroll.x * w.scrollratio.x),
                                  w.opt.cursordragspeed
                                )
                              : w.doScrollTop(
                                  Math.round(w.scroll.y * w.scrollratio.y),
                                  w.opt.cursordragspeed
                                ));
                        }),
                        w.cancelEvent(t)
                  ...
                  (w.onpreventclick = function (t) {
                    return w.preventclick
                      ? ((w.preventclick.tg.onclick = w.preventclick.click),
                        (w.preventclick = !1),
                        w.cancelEvent(t))
                      : void 0;
                  }),
                    ...
                    (w.onclick = b.isios
                      ? !1
                      : function (t) {
                          return w.lastmouseup
                            ? ((w.lastmouseup = !1), w.cancelEvent(t))
                            : !0;
                        }),
                    w.opt.grabcursorenabled &&
                      b.cursorgrabvalue &&
                      (w.css(w.ispage ? w.doc : w.win, {
                ...
                b.hasmstouch &&
                  ...
                  b.cantouch || w.opt.touchbehavior
                    ? (w.bind(
                        b.hasmousecapture ? w.win : document,
                        "mouseup",
                        w.ontouchend
                      ),
                      ...
                      w.opt.cursordragontouch &&
                        ...
                        w.cursorh &&
                          w.bind(w.cursorh, "mousemove", w.onmousemove)))
                    : (w.bind(
                        b.hasmousecapture ? w.win : document,
                        "mouseup",
                        w.onmouseup
                      ...
                      !w.ispage &&
                        ...
                        w.cursorh &&
                          w.bind(w.cursorh, "mouseup", w.onselectionend),
                  ...
                  w.opt.enablemousewheel &&
                    (w.isiframe ||
                      w.bind(
                        b.isie && w.ispage ? document : w.win,
                        "mousewheel",
                        w.onmousewheel
                      ),
                ...
                ((w.onkeypress = function (o) {
                  ...
                  if (
                    ...
                    switch (n) {
                      ...
                      case 63232:
                        w.railh &&
                          (s ? w.doScrollLeft(0) : w.doScrollLeftBy(72),
                          (a = !0));
                        break;
                      case 39:
                      case 63234:
                      ...
                      case 36:
                      case 63273:
                        w.railh && s ? w.doScrollPos(0, 0) : w.doScrollTo(0),
                          (a = !0);
                        break;
                      case 35:
                      case 63275:
                        w.railh && s
                          ? w.doScrollPos(w.page.maxw, w.page.maxh)
                          : w.doScrollTo(w.page.maxh),
                          (a = !0);
                        break;
                      case 32:
                        w.opt.spacebarenabled &&
                          (w.doScrollBy(r ? w.view.h : -w.view.h), (a = !0));
                        break;
                      case 27:
              ...
              (w.onAttributeChange = function () {
                ...
                !w.ispage &&
                  w.opt.boxzoom &&
                  w.bind(window, "resize", w.resizeZoom),
                  ...
                  : ((w.forcescreen = !0),
                    w.isiframe &&
                      ...
                      (w.getContentSize = function () {
                        return {
                          w: Math.max(
                            w.iframe.html.scrollWidth,
                            w.iframe.body.scrollWidth
                          ),
                          h: Math.max(
                            w.iframe.html.scrollHeight,
                            w.iframe.body.scrollHeight
                          ),
                        };
                      }),
                    ...
                    w.lazyResize(30),
                    b.isie7 &&
                      w.css(t(w.iframe.html), { "overflow-y": "hidden" }),
                    ...
                    w.opt.enablemousewheel &&
                      w.bind(i, "mousewheel", w.onmousewheel),
                    w.opt.enablekeyboard &&
                      w.bind(
                        i,
                    ...
                    (b.cantouch || w.opt.touchbehavior) &&
                      ...
                      w.opt.grabcursorenabled &&
                        b.cursorgrabvalue &&
                        w.css(t(i.body), { cursor: b.cursorgrabvalue })),
                    w.bind(i, "mouseup", w.ontouchend),
                    void (
                      w.zoom &&
                      (w.opt.dblclickzoom && w.bind(i, "dblclick", w.doZoom),
                      w.ongesturezoom &&
                        w.bind(i, "gestureend", w.ongesturezoom))
                    ));
              };
          ...
          (this.showCursor = function (t, e) {
            w.cursortimeout &&
              (clearTimeout(w.cursortimeout), (w.cursortimeout = 0)),
              w.rail &&
                (w.autohidedom &&
                  (w.autohidedom
                    .stop()
                    .css({ opacity: w.opt.cursoropacitymax }),
                  (w.cursoractive = !0)),
                (w.rail.drag && 1 == w.rail.drag.pt) ||
                  ("undefined" != typeof t &&
                    !1 !== t &&
                    (w.scroll.y = Math.round((1 * t) / w.scrollratio.y)),
                  "undefined" != typeof e &&
                    (w.scroll.x = Math.round((1 * e) / w.scrollratio.x))),
                ...
                w.cursorh &&
                  ...
                  (w.cursoractive = !0)),
                w.zoom &&
                  w.zoom.stop().css({ opacity: w.opt.cursoropacitymax }));
          }),
            ...
            !w.cursortimeout &&
              ...
              (w.cursortimeout = setTimeout(function () {
                (w.rail.active && w.showonmouseevent) ||
                  (w.autohidedom
                    .stop()
                    .animate({ opacity: w.opt.cursoropacitymin }),
                  w.zoom &&
                    w.zoom.stop().animate({ opacity: w.opt.cursoropacitymin }),
                  (w.cursoractive = !1)),
                  (w.cursortimeout = 0);
          ...
          (this.getContentSize = w.ispage
            ...
            ? function () {
                return {
                  w:
                    w.doc.outerWidth() +
                    parseInt(w.win.css("paddingLeft")) +
                    parseInt(w.win.css("paddingRight")),
                  h:
                    w.doc.outerHeight() +
                    parseInt(w.win.css("paddingTop")) +
                    parseInt(w.win.css("paddingBottom")),
                };
              }
            : function () {
                return {
          ...
          (this.onResize = function (t, e) {
            ...
            if (
              ...
              if (
                ((i = w.win.offset()),
                w.lastposition &&
                  ((o = w.lastposition), o.top == i.top && o.left == i.left))
              )
                return w;
              w.lastposition = i;
            }
            return (
              ...
              w.locked
                ...
                : (w.hidden || w.visibility
                  ...
                  w.istextarea &&
                    w.win.css("resize") &&
                    "none" != w.win.css("resize") &&
                    (w.view.h -= 20),
                  (w.cursorheight = Math.min(
                    w.view.h,
                    Math.round(w.view.h * (w.view.h / w.page.h))
                  )),
                  (w.cursorheight = w.opt.cursorfixedheight
                    ? w.opt.cursorfixedheight
                    : Math.max(w.opt.cursorminheight, w.cursorheight)),
                  (w.cursorwidth = Math.min(
                    w.view.w,
                    Math.round(w.view.w * (w.view.w / w.page.w))
                  )),
                  (w.cursorwidth = w.opt.cursorfixedheight
                    ? w.opt.cursorfixedheight
                    : Math.max(w.opt.cursorminheight, w.cursorwidth)),
                  (w.scrollvaluemax =
                    w.view.h - w.cursorheight - w.cursor.hborder),
                  w.railh &&
                    ((w.railh.width =
                      0 < w.page.maxh ? w.view.w - w.rail.width : w.view.w),
                    (w.scrollvaluemaxw =
                      w.railh.width - w.cursorwidth - w.cursorh.wborder)),
                  ...
                  w.getScrollTop() > w.page.maxh
                    ...
                    : ((w.scroll.y = Math.round(
                        w.getScrollTop() * (1 / w.scrollratio.y)
                      )),
                      (w.scroll.x = Math.round(
                        w.getScrollLeft() * (1 / w.scrollratio.x)
                      )),
                      w.cursoractive && w.noticeCursor()),
                  w.scroll.y &&
                    0 == w.getScrollTop() &&
                    w.doScrollTo(Math.floor(w.scroll.y * w.scrollratio.y)),
                  w)
            );
          }),
          ...
          (this.hideRailHr = function () {
            return w.railh
              ? ((w.railh.visibility = !1), w.railh.css("display", "none"), w)
              : w;
          }),
          (this.show = function () {
          ...
          (this.remove = function () {
            w.stop(),
              ...
              w.unbindAll(),
              b.isie9 &&
                w.win[0].detachEvent("onpropertychange", w.onAttributeChange),
          ...
          (this.onmousewheel = function (t) {
            if (!w.wheelprevented) {
              ...
              if (
                ("auto" == w.opt.oneaxismousemode &&
                  0 != t.deltaX &&
                  (w.opt.oneaxismousemode = !1),
              ...
              return (
                ...
                (w.checkarea = e),
                w.nativescrollingarea
                  ? !0
                  : ((t = v(t, !1, i)) && (w.checkarea = 0), t)
              );
            }
          }),
          ...
          (this.getTransitionSpeed = function (t) {
            ...
            return (
              (t = Math.min(e, Math.round((t / 20) * w.opt.scrollspeed))),
              t > 20 ? t : 0
            );
          }),
          w.opt.smoothscroll
            ? w.ishwscroll && b.hastransition && w.opt.usetransition
              ? ((this.prepareTransition = function (t, e) {
                  var i = e ? (t > 20 ? t : 0) : w.getTransitionSpeed(t),
                    o = i
                      ? b.prefixstyle + "transform " + i + "ms ease-out"
                      : "";
                  return (
                    (w.lasttransitionstyle && w.lasttransitionstyle == o) ||
                      ((w.lasttransitionstyle = o),
                      w.doc.css(b.transitionstyle, o)),
                    i
                  );
                }),
                ...
                (this.doScrollPos = function (t, e, i) {
                  var o = w.getScrollTop(),
                    n = w.getScrollLeft();
                  return (
                    (0 > (w.newscrolly - o) * (e - o) ||
                      0 > (w.newscrollx - n) * (t - n)) &&
                      w.cancelScroll(),
                        ...
                        w.timer
                          ...
                          : void (w.timer = setTimeout(function () {
                              ...
                              (i = t - s),
                                ...
                                w.timerscroll &&
                                  w.timerscroll.tm &&
                                  clearInterval(w.timerscroll.tm),
                                i > 0 &&
                                  (!w.scrollrunning &&
                                    w.onscrollstart &&
                                  ...
                                  b.transitionend
                                    ...
                                    : (w.scrollendtrapped &&
                                        clearTimeout(w.scrollendtrapped),
                                      (w.scrollendtrapped = setTimeout(
                                        w.onScrollTransitionEnd,
                                        i
                                      ))),
                                  (w.timerscroll = {
              ...
              : ((this.doScrollLeft = function (t, e) {
                ...
                (this.doScrollPos = function (t, e, i) {
                  function o() {
                    ...
                    if (w.dst.ay) {
                      var e = w.bzscroll
                          ? w.dst.py + w.bzscroll.getNow() * w.dst.ay
                          : w.newscrolly,
                        i = e - sy;
                      ((0 > i && e < w.newscrolly) ||
                        (i > 0 && e > w.newscrolly)) &&
                    ...
                    w.dst.ax
                      ? ((n = w.bzscroll
                          ? w.dst.px + w.bzscroll.getNow() * w.dst.ax
                          : w.newscrollx),
                        (i = n - sx),
                        ((0 > i && n < w.newscrollx) ||
                          (i > 0 && n > w.newscrollx)) &&
                      ...
                      2 == t
                        ? ((w.timer = 0),
                          ...
                          0 > e
                            ? (e = 0)
                            : e > w.page.maxh && (e = w.page.maxh),
                          0 > n
                            ? (n = 0)
                            : n > w.page.maxw && (n = w.page.maxw),
                  ...
                  var n = w.getScrollTop(),
                    s = w.getScrollLeft();
                  (0 > (w.newscrolly - n) * (e - n) ||
                    0 > (w.newscrollx - s) * (t - s)) &&
                    w.cancelScroll(),
                    (w.newscrolly = e),
                    (w.newscrollx = t),
                    (w.bouncescroll && w.rail.visibility) ||
                      (0 > w.newscrolly
                        ? (w.newscrolly = 0)
                        : w.newscrolly > w.page.maxh &&
                          (w.newscrolly = w.page.maxh)),
                    (w.bouncescroll && w.railh.visibility) ||
                      (0 > w.newscrollx
                        ? (w.newscrollx = 0)
                        : w.newscrollx > w.page.maxw &&
                          (w.newscrollx = w.page.maxw)),
                    (w.dst = {}),
                    (w.dst.x = t - s),
                    (w.dst.y = e - n),
                    ...
                    (w.dst.py = n);
                  var r = Math.round(
                    Math.sqrt(Math.pow(w.dst.x, 2) + Math.pow(w.dst.y, 2))
                  );
                  ...
                  if (
                    (0 == w.dst.x
                      ...
                      : 0 == w.dst.y &&
                        ((c = s), (d = t), (w.dst.ax = 1), (w.dst.px = 0)),
                    (r = w.getTransitionSpeed(r)),
                    i && 1 >= i && (r *= i),
                    (w.bzscroll =
                      r > 0
                        ? w.bzscroll
                          ? w.bzscroll.update(d, r)
                          : new BezierClass(c, d, r, 0, 1, 0, 1)
                        : !1),
                    !w.timer)
                  ) {
                    ((n == w.page.maxh && e >= w.page.maxh) ||
                      (s == w.page.maxw && t >= w.page.maxw)) &&
                      w.checkContentSize();
                    var h = 1;
          ...
          (this.doScrollLeftBy = function (t, e) {
            ...
            return (
              ...
              (0 > i && 0 >= px) || (i > w.page.maxw && px >= w.page.maxw)
                ? w.noticeCursor()
                : void w.doScrollLeft(i)
            );
          }),
          (this.doScrollTo = function (t, e) {
            e && Math.round(t * w.scrollratio.y),
              (w.cursorfreezed = !1),
              w.doScrollTop(t);
          }),
          ...
          (this.doZoomIn = function (e) {
            if (!w.zoomactive) {
              ...
              return (
                ...
                b.isios4 &&
                  ((w.zoomrestore.scrollTop = t(window).scrollTop()),
    ...
    (t.cssHooks.pageXOffset = {
      ...
      set: function (e, i) {
        var o = t.data(e, "__nicescroll") || !1;
        return (
          o && o.ishwscroll ? o.setScrollLeft(parseInt(i)) : w.call(e, i), this
        );
      },
    }),
      ...
      handleClick: function (i) {
        ...
        s.hasClass(o.config.currentClass) ||
          ...
          o.scrollTo(r, function () {
            o.config.changeHash && (e.location.hash = r),
              o.bindInterval(),
  ...
  (function () {
    ...
    $(window).scroll(function () {
      300 < $(window).scrollTop() &&
        !e &&
        (t.addClass("bg-change animated"), (e = !0)),
        300 > $(window).scrollTop() &&
          e &&
          (t.removeClass("bg-change animated"), (e = !1));
    });
  })(),
    ...
    var i = $("#project-items"),
      ...
      n = function () {
        i.isotope({
          resizable: !0,
          itemSelector: ".item",
          masonry: { columnWidth: o(), gutterWidth: 10 },
        });
      };
    n(),
